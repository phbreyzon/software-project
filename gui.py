...
class App(customtkinter.CTk): 
    def __init__(self):
        ...
        self.frame_for_button_and_entry.grid(row=1, column=0, padx=20, sticky="nsew", pady=(30, 30))
                

        # The entry where you enter your songs
        self.entry = customtkinter.CTkEntry(master=self.frame_for_button_and_entry, placeholder_text="Enter recommendation", width=300)
        self.entry.grid(row=0, column=4, padx=20, pady=20, sticky="nsew")
        ...
        self.button.grid(row=1, column=4, padx=20, pady=20, sticky="nsew")
